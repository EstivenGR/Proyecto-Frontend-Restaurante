...
class ReservaCreate(BaseModel):
    ...
    # 🛑 NUEVO CAMPO DE HORA (Input para el POST) 🛑
    # Usamos string para el formato HH:MM (ej: "19:00")
...
class ReservaRead(BaseModel):
    ...
    # 🛑 NUEVO CAMPO DE HORA (Output para el GET/Reporte) 🛑
    hora_reserva: str = Field(..., description="Hora de la reserva (formato HH:MM)")
    
    requerimientos: Optional[str]

class ReservaBase(BaseModel):
    # Asegúrate de que tu modelo de base de datos también incluya hora_reserva 
